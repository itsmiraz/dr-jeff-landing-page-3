...
const About = () => {
  return (
    <div className="mt-[60px] md:mt-[150px]">
      <div className="max-w-[1077px] px-[20px] gap-y-[40px] md:flex-row flex-col-reverse flex justify-between items-center md:px-[40px] p-[40px] rounded-[0px] md:rounded-[40px] mx-auto bg-[#F5F7F9]">
        <div>
