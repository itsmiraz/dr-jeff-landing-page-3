  ...
  return (
    <div className="mt-[150px]">
      <div className="bg-[#1B365D] flex justify-between  mx-auto items-center px-[20px] w-full max-w-[2200px]">
        <Image className="md:block hidden" src={Lines} alt="" />
        <div className="pt-[50px]  pb-[40px]">
          <h3 className={`${font_platinPro}  px-[20px] md:px-0 text-[34px] md:text-[40px]  text-center font-bold leading-[46px] text-white`}>
          ...
          <p className="text-[24px] md:text-[30px] font-source-sans mt-[20px] text-center  text-white">
            Don't let spine pain control your life any longer
          </p>
          <div className="flex md:flex-row   mt-[45px] flex-col gap-y-[20px] gap-x-[40px] justify-center items-center">
            ...
            <button className="gap-x-[10px] font-source-sans   flex items-center w-fit px-5 py-[13px] border-secondary border  rounded-[100px]">
              <div className="grow text-sm font-bold leading-loose text-white">
          ...
          <p className="text-[16px] md:text-[20px]  font-source-sans underline mt-[40px] gap-x-[12px] flex items-center justify-center font-semibold text-[#A65D57]">
